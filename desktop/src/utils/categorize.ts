...
export const CATEGORIES: CategoryInfo[] = [
  ...
  { name: '通讯工具', icon: '\u{1F4AC}', keywords: ['wechat', '微信', 'discord', 'slack', 'telegram', 'zoom', 'teamview', '钉钉', 'dingtalk', '飞书', 'feishu', 'lark', 'qq', 'skype', 'whatsapp', 'tim', 'teams', 'signal', 'viber', 'line', 'kakaotalk', 'messenger', 'element', 'hexchat', 'trello', 'asana', 'twist', 'webex', 'zoho', 'tencent meeting', 'voov', 'ooopz', 'oopz'] },
