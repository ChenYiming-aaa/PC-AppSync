...
const iconMap = new Map([
  ...
  ['starfield', 'starfield'], ['star citizen', 'starcitizen'],
  ...
  ['腾讯视频', 'tencentvideo'], ['tencent video', 'tencentvideo'],
  ['优酷', 'youku'], ['youku', 'youku'],
  ['豆瓣', 'douban'], ['知乎', 'zhihu'],
  ['微博', 'sinaweibo'], ['sina', 'sinaweibo'],
  ['美团', 'meituan'], ['饿了么', 'eleme'],
  ['携程', 'ctrip'], ['去哪儿', 'qunar'],
  // Development tools (more)
  ['kubernetes', 'kubernetes'], ['k8s', 'kubernetes'],
  ['docker', 'docker'], ['podman', 'podman'],
  ['nginx', 'nginx'], ['apache', 'apache'],
  ['tomcat', 'apachetomcat'], ['jenkins', 'jenkins'],
  ...
  // Browsers
  ['chrome', 'googlechrome'], ['firefox', 'firefoxbrowser'],
  ['edge', 'microsoftedge'], ['opera', 'opera'],
  ['brave', 'brave'], ['vivaldi', 'vivaldi'],
  ['safari', 'safari'], ['tor', 'torbrowser'],
  // Security
  ['360', '360totalsecurity'], ['卡巴', 'kaspersky'],
